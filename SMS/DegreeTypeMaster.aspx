<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="DegreeTypeMaster.aspx.cs" Inherits="SMS.DegreeTypeMaster" %>
        ...
        <ContentTemplate>
            ...
            <div class="page-content-wrapper" style="margin-bottom: -16px;">
                <div class="page-content">
                    <h3 class="page-title bold">Degree Type</h3>
                    <div class="row" id="divgrid" runat="server">
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="material-icons">&#xe418;</i>Degree Type List
                                    </div>
                                    ...
                                    <div class="tools">
                                        <asp:LinkButton ID="lnkAdd" runat="server" class="pull-right" Style="color: white" OnClick="lnkAdd_Click">
                                              <i class="fa fa-plus" title="Add New Degree Type"></i>
                                        </asp:LinkButton>
                                    </div>
                                ...
                                <div class="portlet-body" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="10" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="85%" HeaderText="Degree Type Name" SortExpression="Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDegreeType" runat="server" Text='<%#Eval("Name") %>'></asp:Label>
                            ...
                            <div class="portlet-body form">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item active" id="liPersonalDetails" runat="server">
                                        <a class="nav-link" data-toggle="tab" href="#ContentPlaceHolder1_divPersonalDetails" id="aPersonalDetails" runat="server">Degree Type Details</a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtDegreeType" runat="server" CssClass="form-control" BorderColor="#37359C" placeholder="Degree Type Name" Style="background-color: LightGrey;"></asp:TextBox>
                                                                <asp:Label ID="lblValidDegreeTypename" runat="server" Style="color: red;" Text="* Enter Degree Type name..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
