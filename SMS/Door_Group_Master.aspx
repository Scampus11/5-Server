<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Door_Group_Master.aspx.cs" Inherits="SMS.Door_Group_Master" %>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold">Door Group Master
                <small> Door Group-list </small>
                <!-- BEGIN EXAMPLE TABLE PORTLET-->
                <%--<a class="btn green-meadow pull-right" data-toggle="modal" href="#static">
                    Add New Department
                    <i class="fa fa-plus"></i> </a>--%>
                <asp:LinkButton ID="lnkAdd" runat="server" Text="Add New Door Group" class="btn green-meadow pull-right" OnClick="lnkAdd_Click">
            ...
            <!-- END PAGE TITLE-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green-meadow">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-briefcase"></i>Door Group List
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                ...
                <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="5">
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Door Group Id" SortExpression="Id">
                            <ItemTemplate>
                                <asp:Label ID="lblId1" runat="server" Text='<%#Eval("Id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Door Group Name" SortExpression="Door_Name">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Description" SortExpression="Description">
                         ...
                         <asp:TemplateField ItemStyle-Width="30px" HeaderText="Reader Name" SortExpression="Reader_Id">
                            <ItemTemplate>
                                    ...
                                    <div class="modal-body">
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Door Group Name : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12" id="Div3">
                                                                            <div class="input-group">
                                                                                <asp:Repeater ID="RepeatReader" runat="server">
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="chkReader" runat="server" Text='<%# Eval("Name")  %>'  />&nbsp;
                                                                                        <asp:Label ID ="lblId" runat="server" Text='<%# Eval("Id") %>' Visible="false"></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    </asp:Repeater>
                                                                            </div>
