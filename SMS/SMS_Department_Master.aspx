<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="SMS_Department_Master.aspx.cs" Inherits="SMS.SMS_Department_Master" %>
        ...
        <ContentTemplate>
            ...
            <div class="page-content-wrapper" style="margin-bottom: -16px;">
                <div class="page-content">
                    <h3 class="page-title bold">Department</h3>
                    <div class="row" id="divgrid" runat="server">
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="material-icons">&#xe32a;</i>Department List
                                    </div>
                                    ...
                                    <div class="tools" id="divadd" runat="server" visible="true">
                                        <asp:LinkButton ID="lnkAdd" runat="server" class="pull-right" Style="color: white" OnClick="lnkAdd_Click">
                                              <i class="fa fa-plus" title="Add New Department"></i>
                                        </asp:LinkButton>
                                    </div>
                                ...
                                <div class="portlet-body" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="10" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-Width="6%" HeaderText="Id" SortExpression="Id">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId1" runat="server" Text='<%#Eval("Id") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-Width="42%" HeaderText="Department Name" SortExpression="Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblApplication_No" runat="server" Text='<%#Eval("Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-Width="42%" HeaderText="College Name" SortExpression="CollegeId">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStaff_Id" runat="server" Text='<%#Eval("CollegeId") %>'></asp:Label>
                            ...
                            <div class="portlet-body form">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item active" id="liPersonalDetails" runat="server">
                                        <a class="nav-link" data-toggle="tab" href="#ContentPlaceHolder1_divPersonalDetails" id="aPersonalDetails" runat="server">Department Details</a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtApplication_No" runat="server" CssClass="form-control" placeholder="Department Name" Style="background-color: LightGrey;" BorderColor="#37359C"></asp:TextBox>
                                                                <asp:Label ID="lblValidDepartmentname" runat="server" Style="color: red;" Text="* Enter department name..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" Style="background-color: LightGrey;" BorderColor="#37359C">
                                                                </asp:DropDownList>
                                                                <asp:Label ID="lblCampus" runat="server" Style="color: red;" Text="* Enter College name..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
