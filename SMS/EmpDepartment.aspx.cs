...
namespace SMS
{
    public partial class EmpDepartment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["Sider"] = "Staff Department";
            ...
            if (!Page.IsPostBack)
            {
                try
                {
                    if (Request.QueryString["Id"] != null)
                    {
                        ...
                        cmd.CommandText = "select * from tblEmpDepartment where Id= '" + Request.QueryString["Id"].ToString() + "'";
                        cmd.Connection = con;
                        cmd.ExecuteNonQuery();
        ...
        protected void FillGrid(string sortExpression = null)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("GetEmpDepartment", con);
        ...
        {
            Response.Redirect("EmpDepartment.aspx?Insert=Added");
        }
        protected void linkEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EmpDepartment.aspx?Id=" + ids);
        }
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "INSERT INTO tblEmpDepartment ([Name] ,[Id]) VALUES ('" + txtApplication_No.Text + "','" + txtDepartmentId.Text + "')";
                    cmd.Connection = con;
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                try
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "UPDATE tblEmpDepartment SET [Name] = '" + txtApplication_No.Text + "',Id = '" + txtDepartmentId.Text + "' WHERE Id='" + Convert.ToInt32(Request.QueryString["Id"]) + "'";
                    cmd.Connection = con;
                    cmd.ExecuteNonQuery();
                    Response.Redirect("EmpDepartment.aspx");
                    con.Close();
        ...
        protected void linkDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = "Delete from tblEmpDepartment where Id= '" + Ids.Text + "'";
                cmd.Connection = con;
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                cmd.ExecuteNonQuery();
                FillGrid();
        ...
        {
            SqlCommand cmd = new SqlCommand("SyncEmpDepartMent", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = con;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
