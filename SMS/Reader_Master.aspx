<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reader_Master.aspx.cs" Inherits="SMS.Reader_Master" %>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold">Reader Master
                <small> Reader-list </small>
                <!-- BEGIN EXAMPLE TABLE PORTLET-->
                <%--<a class="btn green-meadow pull-right" data-toggle="modal" href="#static">
                    Add New Department
                    <i class="fa fa-plus"></i> </a>--%>
                <asp:LinkButton ID="lnkAdd" runat="server" Text="Add New Reader" class="btn green-meadow pull-right" OnClick="lnkAdd_Click">
            ...
            <!-- END PAGE TITLE-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green-meadow">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-briefcase"></i>Reader List
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                ...
                <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="5">
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Reader Id" SortExpression="Id">
                            <ItemTemplate>
                                <asp:Label ID="lblId1" runat="server" Text='<%#Eval("Id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Reader Name" SortExpression="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblApplication_No" runat="server" Text='<%#Eval("Name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Reader Type" SortExpression="Reader_Type">
                            <ItemTemplate>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Reader Name : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
