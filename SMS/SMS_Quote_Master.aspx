<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="SMS_Quote_Master.aspx.cs" Inherits="SMS.SMS_Quote_Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content-wrapper" style="margin-bottom: -16px;">
        <div class="page-content">
            <h3 class="page-title bold">Quotes</h3>
            <div class="row" id="divgrid" runat="server">
                <div class="col-md-12">
                    <div class="portlet box green-meadow">
                        <div class="portlet-title">
                            <div class="caption">
                                <i  class='fab'>&#xf2c4;</i>Quotes List
                            </div>
                            ...
                            <div class="tools">
                                <asp:LinkButton ID="lnkAdd" runat="server" class="pull-right" Style="color: white" OnClick="lnkAdd_Click">
                                              <i class="fa fa-plus" title="Add New Quote"></i>
                                </asp:LinkButton>
                            </div>
                        </div>
                        <div class="portlet-body" style="overflow: scroll">
                            <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-Width="30px" HeaderText="Quote Name" SortExpression="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApplication_No" runat="server" Text='<%#Eval("QuoteName") %>'></asp:Label>
                                            <asp:Label ID="lblid" runat="server" Text='<%#Eval("QuoteId") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="30px" HeaderText="Canteen Name" SortExpression="Id">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblId1" runat="server" Visible="false" Text='<%#Eval("QuoteId") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="10px" HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="linkEdit" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "QuoteId")%>' OnClick="linkEdit_Click"><i class="material-icons" title="Edit row">&#xe3c9;</i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="modal-body">
                    <div class="portlet-body form">
                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" id="Div2">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:Label ID="lblValidCanteenName" runat="server" Style="color: red;" Text="* Select canteen name..." Visible="false"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" id="Div2">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:Label ID="lblValidSessionName" runat="server" Style="color: red;" Text="* Select session name..." Visible="false"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="text-success">Quote Name : </label>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="description" style="width: 100%; border: 1px solid #ddd; padding: 10px; border-radius: 5px">
                                            <div class="row">
                                                <div class="col-md-12" id="Div1">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtQuoteName" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <asp:Label ID="lblValidQuotename" runat="server" Style="color: red;" Text="* Enter Quote name..." Visible="false"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="text-success">Quote Status : </label>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="description" style="width: 100%; border: 1px solid #ddd; padding: 10px; border-radius: 5px">
                                            <div class="row">
