...
namespace SMS
{
    public partial class SMS_Country_Master : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    cmd.CommandText = "select * from tbl_Country where Id= '" + Request.QueryString["Id"].ToString() + "'";
        ...
        protected void FillGrid(string sortExpression = null)
        {
            ...
            try
            {
                ...
                //cmd.Connection = con;
                SqlCommand cmd = new SqlCommand("SP_GetCountryData", con);
        ...
        {
            Response.Redirect("SMS_Country_Master.aspx?Insert=Insert Department");
        }
        protected void linkEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("SMS_Country_Master.aspx?Id=" + ids);
        }
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            {
                try { 
                lblValidCountryname.Visible = false;
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = "INSERT INTO [tbl_Country] ([Name]) VALUES ('" + txtApplication_No.Text + "')";
                cmd.Connection = con;
                //ScriptManager.RegisterStartupScript(this, GetType(), "", "alert('Insert Successfully!!');", true);

                con.Open();
                cmd.ExecuteNonQuery();
                Response.Redirect("SMS_Country_Master.aspx");
                con.Close();
                }
                catch (Exception ex)
                {
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = "UPDATE [tbl_Country] SET [Name] = '" + txtApplication_No.Text + "' WHERE Id='" + Convert.ToInt32(Request.QueryString["Id"]) + "'";
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                Response.Redirect("SMS_Country_Master.aspx");
                con.Close();
        ...
        protected void linkDelete_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Delete from tbl_Country where Id= '" + Ids.Text + "'";
            cmd.Connection = con;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            cmd.ExecuteNonQuery();
            FillGrid();
        ...
        protected bool Validation()
        {
            ...
            {
                lblValidCountryname.Visible = true;
