<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Officer_Master.aspx.cs" Inherits="SMS.Officer_Master" %>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title bold">Employee / Officer Master
                <small>Employee / Officer-list </small>
                        <!-- BEGIN EXAMPLE TABLE PORTLET-->
                        <asp:LinkButton ID="lnkAdd" runat="server" Text="Add New Officer" class="btn green-meadow pull-right" OnClick="lnkAdd_Click"></asp:LinkButton>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-briefcase"></i>Employee / Officer List
                                    </div>
                                    <div class="tools">
                                    </div>
                                </div>
                                    ...
                                    <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="10">
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-Width="20px" HeaderText="Images" >
                                                <ItemTemplate>
                                                    <asp:Image ID="tmgstudent" runat="server" ImageUrl='<%#Eval("Emp_photo") %>' class="circle" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="30px" HeaderText="UId" SortExpression="UId">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="100px" HeaderText="Full Name" SortExpression="Full_Name">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="100px" HeaderText="Job_Title" SortExpression="Job_Title">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblJob_Title" runat="server" Text='<%#Eval("Job_Title") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-Width="100px" HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="linkView" class="btn green-meadow" runat="server" Text="View" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id")%>' OnClick="linkView_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <div class="modal-body">
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" id="Div1">
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtApplication_No" runat="server" Enabled="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="description" style="width: 100%; border: 1px solid #ddd; padding: 10px; border-radius: 5px">
                                                    <div class="row">
                                                        <div class="col-md-12" id="Div2">
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtSL_No" runat="server"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <label class="text-success">UID : </label>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="description" style="width: 100%; border: 1px solid #ddd; padding: 10px; border-radius: 5px">
                                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="text-success">DOB : </label>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="description" style="width: 100%; border: 1px solid #ddd; padding: 10px; border-radius: 5px">
                                                    <div class="row">
