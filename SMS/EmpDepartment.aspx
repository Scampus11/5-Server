<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="EmpDepartment.aspx.cs" Inherits="SMS.EmpDepartment" %>
        ...
        <ContentTemplate>
            ...
            <div class="page-content-wrapper" style="margin-bottom: -16px;">
                <div class="page-content">
                    <h3 class="page-title bold">Staff Department</h3>
                    <div class="row" id="divgrid" runat="server">
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="material-icons">&#xe32a;</i>Staff Department List
                                    </div>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtDepartmentId" runat="server" CssClass="form-control" placeholder="Department Id" Style="background-color: LightGrey;" BorderColor="#37359C"></asp:TextBox>
                                                                <asp:Label ID="lblDepartmentId" runat="server" Style="color: red;" Text="* Enter Department Id..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
