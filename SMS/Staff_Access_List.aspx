<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff_Access_List.aspx.cs" Inherits="SMS.Staff_Access_List" %>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold">Staff Access List  Master
                <small> Staff Access List  </small>
            ...
            <!-- END PAGE TITLE-->
                            ...
                            <div class="col-md-12">
                                <div class="portlet box green-meadow">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-briefcase"></i>Staff  Access List  
                                        </div>
                                    </div>
                ...
                <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="10">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Staff Name" SortExpression="Staff_Name">
                            <ItemTemplate>
