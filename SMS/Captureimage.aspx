    ...
    <div class="PhotoUploadWrapper">
        ...
        <div class="PhotoUploadContent">
            <div class="PhotoUpoloadHeader">
                Select photo
                <a href="SMS_Visitor_SelfRegistration.aspx" style="float: left; font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 35px; text-indent: 18px; font-weight: bold; "> Back</a>
            </div>
        ...
        function UploadPic() {
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    window.location.href = "SMS_Visitor_SelfRegistration.aspx";
