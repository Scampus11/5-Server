<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="EmpFacility.aspx.cs" Inherits="SMS.EmpFacility" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Staff Facility</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div class="page-content-wrapper" style="margin-bottom: -16px;">
                <div class="page-content">
                    <h3 class="page-title bold">Staff Facility</h3>
                    <div class="row" id="divgrid" runat="server">
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="glyphicon">&#xe247;</span>Staff Facility List
                                    </div>
                                    ...
                                    <div class="tools" id="divadd" runat="server" visible="true">
                                        <asp:LinkButton ID="lnkAdd" runat="server" class="pull-right" Style="color: white" OnClick="lnkAdd_Click">
                                              <i class="fa fa-plus" title="Add New Facility"></i>
                                        </asp:LinkButton>
                                    </div>
                                ...
                                <div class="portlet-body" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="10" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="42%" HeaderText="Facility Name" SortExpression="Name">
                                                <ItemTemplate>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtDepartmentId" runat="server" CssClass="form-control" placeholder="Facility Id" Style="background-color: LightGrey;" BorderColor="#37359C"></asp:TextBox>
                                                                <asp:Label ID="lblDepartmentId" runat="server" Style="color: red;" Text="* Enter Facility Id..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtApplication_No" runat="server" CssClass="form-control" placeholder="Facility Name" Style="background-color: LightGrey;" BorderColor="#37359C"></asp:TextBox>
                                                                <asp:Label ID="lblValidDepartmentname" runat="server" Style="color: red;" Text="* Enter facility name..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
