...
namespace SMS
{
    public partial class SMS_SQL_Connection_Dynamic : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                Session["Sider"] = "DataBase Connection";
                Authentication();
            }
        }
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string root = Server.MapPath(WebConfigurationManager.AppSettings["ConPath"].ToString());
