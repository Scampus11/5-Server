<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Student_Card_Assignment.aspx.cs" Inherits="SMS.Student_Card_Assignment" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Student Card Assignment </title>
</asp:Content>
    ...
    <script type="text/javascript">
        function Export() {
            ...
            $("#ContentPlaceHolder1_gridEmployee").table2excel({
                ...
                filename: "Student_Card_Assignment.xls"
            });
        }
    </script>
    <script type="text/javascript">
                        ...
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class='far'>&#xf2c2;</i>Student Card Assignment 
                                    </div>
                                    <div class="tools">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server" ChildrenAsTriggers="true">
                                        ...
                                        <div class="row">
                                            <div class='col-sm-12 pull-left'>
                                                <div class="form-group">
                                                    ...
                                                    <i id="icheckcardnumber" class="fa fa-check-circle hide" style="color: green" runat="server"></i>
                 ...
                 */
                            ...
                            $(document).on('input', '.clearable', function () {
                                ...
                                ev.preventDefault();
                                $(this).removeClass('x onX').val('').change();
                                $("#ContentPlaceHolder1_icheckcardnumber").addClass("hide");
                            });
                        ...
                        function SearchText() {
                            $("#ContentPlaceHolder1_txtStudent").autocomplete({
                                source: function (request, response) {
                                    $.ajax({
                                        ...
                                        url: "Student_Card_Assignment.aspx/GetStudentInfo",
                            ...
                            $("#ContentPlaceHolder1_txtCardNumber").autocomplete({
                                source: function (request, response) {
                                    $.ajax({
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                                        url: "Student_Card_Assignment.aspx/GetCardNumber",
                                        data: "{'StudentName':'" + document.getElementById('ContentPlaceHolder1_txtCardNumber').value + "'}",
                                        dataType: "json",
                                        success: function (data) {
                            ...
                            $("#ContentPlaceHolder1_txtCardNumber").bind("autocompleteselect", function (event, ui) {
                                ...
                                $("#ContentPlaceHolder1_icheckcardnumber").removeClass("hide");
                            });
