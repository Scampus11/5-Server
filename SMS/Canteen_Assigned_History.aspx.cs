...
namespace SMS
{
    public partial class Canteen_Assigned_History : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["Sider"] = "Student Canteen Assignment";
        ...
        {
            Response.Redirect("Canteen_Assigned_History.aspx");
        }
        ...
        protected void FillGrid(string sortExpression = null)
        {
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
                cmd.Parameters.AddWithValue("@Flag", "Get Canteen Assign History");
                cmd.Parameters.AddWithValue("@Session", ddlcanteenType.SelectedValue);
        ...
        public static List<string> GetStudentInfo(string StudentName)
        {
            ...
            {
                cmd.CommandText = "select Distinct StudentId from tbl_CanteenAssign_History where StudentId!='' and StudentId is not null and StudentId  LIKE '%'+@SearchEmpName+'%'";
