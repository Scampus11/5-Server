<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Session_Master.aspx.cs" Inherits="SMS.Session_Master" %>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold">Session Master
                <small> Session-list </small>
                <!-- BEGIN EXAMPLE TABLE PORTLET-->
                <%--<a class="btn green-meadow pull-right" data-toggle="modal" href="#static">
                    Add New Department
                    <i class="fa fa-plus"></i> </a>--%>
                <asp:LinkButton ID="lnkAdd" runat="server" Text="Add New Session" class="btn green-meadow pull-right" OnClick="lnkAdd_Click">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green-meadow">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-briefcase"></i>Session List
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" ShowFooter="true">
                    <PagerSettings Mode="NumericFirstLast" PageButtonCount="5" FirstPageText="First" LastPageText="Last"/>
                                        <pagerstyle cssclass="gridview"></pagerstyle>
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Session Id" SortExpression="Session_Id">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Session Description" SortExpression="Session_Description">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="Start Time" SortExpression="Start_Time">
                            <ItemTemplate>
                                <asp:Label ID="lblStart_Time" runat="server" Text='<%#Eval("Start_Time") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-Width="30px" HeaderText="End Time" SortExpression="End_Time">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-Width="50px" HeaderText="VIEW/Edit">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="linkEdit" class="btn green-meadow" runat="server" Text="Edit" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Session_Id")%>' OnClick="linkEdit_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Session Description : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                                        <div class="col-md-12" id="Div2">
                                                                            <div class="input-group">
                                                                                <asp:TextBox ID="txtSessionDescription" runat="server"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <hr/>
                                                   ...
                                                   <div class="form-group">
                                                        <label class="text-success"> Start Time : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> End Time : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                ...
                                                <%--<hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Full_Name : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Job_Title : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                                        <div class="col-md-12" id="Div7">
                                                                            <div class="input-group">
                                                                                <asp:TextBox ID="txtJob_Title" runat="server"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Emp Photo : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Issue_Date : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                                        <div class="col-md-12" id="Div12">
                                                                            <div class="input-group">
                                                                                <asp:TextBox ID="txtIssue_Date" runat="server" TextMode="DateTime"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <hr/>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-success"> Card_no : </label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="description" style="width: 100%;border: 1px solid #ddd;padding: 10px;border-radius: 5px" >
                                                                    <div class="row">
                                                                        <div class="col-md-12" id="Div15">
                                                                            <div class="input-group">
                                                                                <asp:TextBox ID="txtCard_no" runat="server"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
