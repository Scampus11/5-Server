<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="SMS_Visitor_Access_Level.aspx.cs" Inherits="SMS.SMS_Visitor_Access_Level" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Visitor Access Levels</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div class="page-content-wrapper" style="margin-bottom: -16px;">
                <div class="page-content">
                    <h3 class="page-title bold">Visitor Access Levels</h3>
                    <div class="row" id="divgrid" runat="server">
                        <div class="col-md-12">
                            <div class="portlet box green-meadow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i  class="fa">&#xf221;</i>Visitor Access Level List
                                    </div>
                                    ...
                                    <div class="tools">
                                        <asp:LinkButton ID="lnkAdd" runat="server" class="pull-right" Style="color: white" OnClick="lnkAdd_Click">
                                              <i class="fa fa-plus" title="Add New Visitor Acess Level"></i>
                                        </asp:LinkButton>
                                    </div>
                                </div>
                                <div class="portlet-body" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="gridEmployee" runat="server" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSorting="OnSorting" OnPageIndexChanging="OnPageIndexChanging" PageSize="5" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="350px" HeaderText="Visitor Access Level" SortExpression="VisitorAccesslevel">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblApplication_No" runat="server" Text='<%#Eval("VisitorAccesslevel") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="text-success">Visitor Access Level : </label>
                                        <div class="row">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" id="Div1">
                                                            <div class="input-group">
                                                                ...
                                                                <asp:Label ID="lblValidreadername" runat="server" Style="color: red;" Text="* Enter Visitor Access Level..." Visible="false"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
